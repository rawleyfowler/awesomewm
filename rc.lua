...
beautiful.init("/home/rf/.config/awesome/themes/tokyonight/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    beautiful.hotkeys_font = "Hurmit Nerd Font Mono 8"
    beautiful.hotkeys_description_font = "Hurmit Nerd Font Mono 8"
    beautiful.menu_font = "Hurmit Nerd Font Mono 8"
    ...
    awful.key({ modkey, }, "d",
        function()
            awful.spawn.with_shell(
                'rofi -no-lazy-grab -theme /home/rf/.config/rofi/themes/launcher.rasi -show drun')
        end,
...
awful.spawn.with_shell('xrandr --rate 144.00')
